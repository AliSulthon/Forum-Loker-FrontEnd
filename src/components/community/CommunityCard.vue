<template>
  ...
  >
    ...
    <!-- Nama komunitas -->
    <h2 class="text-2xl font-semibold text-black mb-3 line-clamp-1">
      {{ community.name }}
    </h2>
    ...
    <!-- Tombol detail di pojok kanan bawah -->
    <span
